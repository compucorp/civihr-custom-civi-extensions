...
class CRM_Hrjobcontract_Page_JobsTab extends CRM_Core_Page {
  function run() {
    ...
    CRM_Core_Resources::singleton()
      ...
      return array(
        'PseudoConstant' => array(
          ...
          'job_hours_time' => CRM_Hrjobcontract_Page_JobsTab::getJobHoursTime(),
          'working_days' => CRM_Hrjobcontract_Page_JobsTab::getDaysPerTime(),
        ),
        'FieldOptions' => CRM_Hrjobcontract_Page_JobsTab::getFieldOptions(),
        'jobTabApp' => array(
          ...
          'currencies' => CRM_Hrjobcontract_Page_JobsTab::getCurrencyFormats(),
